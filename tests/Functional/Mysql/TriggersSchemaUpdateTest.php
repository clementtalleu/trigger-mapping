...
use Talleu\TriggerMapping\Tests\Application\Entity\MysqlUpdateSchemaTestEntity;
...
final class TriggersSchemaUpdateTest extends AbstractTriggersSchemaUpdateTestCase
{
    ...
    {
        return MysqlUpdateSchemaTestEntity::class;
    }

    public function testExecuteApplyMode(): void
    {
        $this->createSchemaForEntities([MysqlUpdateSchemaTestEntity::class]);
        ...
        $commandTester->execute(['--force' => true, '--entity' => MysqlUpdateSchemaTestEntity::class]);
